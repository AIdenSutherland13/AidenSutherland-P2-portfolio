...
@fig-result2 shows that there is no correlation between height and weight. 
```{r}
#| label: fig-result2
#| fig-cap: "Age and weight scatterplot."
#| echo: FALSE
knitr::include_graphics(here("starter-analysis-exercise","results","figures","Age-weight-scatter.png"))
```

@fig-result3 appears to show that 3 of the 4 bloodtypes show normal(ish) distributions while O positive is skewed to the right.
```{r}
#| label: fig-result3
#| fig-cap: "Age and weight scatterplot."
#| echo: FALSE
knitr::include_graphics(here("starter-analysis-exercise","results","figures","height-blood-boxplot.png"))
```
## Full analysis
